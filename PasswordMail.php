...
class PasswordMail
{
    ...
    public function sendMail($email,$hash,$name,$current_time)
    {
        ...
        $this->base_url = "http://ec2-3-6-47-234.ap-south-1.compute.amazonaws.com/reset?email=${email}&hash=${hash}&time=${current_time}";
        $this->mailContent = 
            'Hi ' . $name . ', <br/> <br/> We received a request to reset your password for your E-Library account: 
        <br/> <br/> ' .
        $email . '. We are here to help!
            <br/> <br/>
            Simply click on the link to set a new password. The link will expire after 24 hours.
            <br/> <br/>
